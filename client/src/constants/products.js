export const FEATURED_PRODUCTS = [
  ...
  },
  {
    ...
    images: [
      {
        url: "https://placehold.co/600x600?text=Galaxy+1",
        alt: "Galaxy front view",
      },
      {
        url: "https://placehold.co/600x600?text=Galaxy+2",
        alt: "Galaxy side view",
      },
    ],
    specs: {
      Capacity: "128GB",
    ...
    features: [
      "Exynos 2100 processor for powerful performance",
...
export const BEST_OFFERS = [
  {
    ...
    images: [
      {
        url: "https://placehold.co/600x600?text=Headphones+1",
        alt: "Headphones front view",
      },
      {
        url: "https://placehold.co/600x600?text=Headphones+2",
  ...
  },
  {
    ...
    images: [
      {
        url: "https://placehold.co/600x600?text=iPad+1",
        alt: "iPad front view",
      },
      {
        url: "https://placehold.co/600x600?text=iPad+2",
        alt: "iPad side view",
      },
    ],
    specs: {
  ...
  },
  {
    ...
    images: [
      {
        url: "https://m.media-amazon.com/images/I/51O+J5jnXcL._SX466_.jpg",
        alt: "Cetaphil front view",
      },
      {
        url: "https://m.media-amazon.com/images/I/51y3iSPHq2L._SX466_.jpg",
        alt: "Cetaphil back view",
      },
      {
        url: "https://m.media-amazon.com/images/I/61x0vwD3TcL._SX466_.jpg",
        alt: "Benifits",
      },
    ],
    specs: {
      Brand: "Cetaphil",
      ItemWeight: "125 Milligram",
      Age: "18 and above",
      SkinType: "Sensitive, Dry, Normal",
      "Product Benefits": "cleansing",
    },
    features: [
      "Non-Comedogenic, Hypoallergenic formula free from Parabens, Sulphates, Fragrances & Oils",
      "Formulated with Micellar Technology that gently yet effectively removes dirt, makeup and impurities.",
      "Blend of Niacinamide, Vitamin B5 and Hydrating Glycerin to reinforce skin’s natural moisture barrier even after repeat washes.",
  ...
  },
  {
    ...
    images: [
      {
        url: "https://placehold.co/600x600?text=MacBook+1",
        alt: "MacBook front view",
      },
      {
        url: "https://placehold.co/600x600?text=MacBook+2",
        alt: "MacBook side view",
      },
    ],
    specs: {
      Capacity: "256GB",
  ...
  },
  {
    ...
    features: [
      ...
      "High-resolution 2.36M-dot OLED EVF",
    ],
  },
  {
    id: 8,
    ...
    images: [
      {
        url: "https://placehold.co/600x600?text=Drone+1",
        alt: "Drone front view",
      },
      {
        url: "https://placehold.co/600x600?text=Drone+2",
        alt: "Drone side view",
      },
    ],
    specs: {
    ...
    features: [
      "48MP camera with 1/2-inch CMOS sensor",
      "4K/60fps video",
  ...
  },
  {
    ...
    images: [
      {
        url: "https://placehold.co/600x600?text=Watch+1",
        alt: "Watch front view",
      },
      {
        url: "https://placehold.co/600x600?text=Watch+2",
        alt: "Watch side view",
      },
    ],
    specs: {
  ...
  },
  {
    ...
    images: [
      {
        url: "https://placehold.co/600x600?text=Monitor+1",
        alt: "Monitor front view",
      },
      {
        url: "https://placehold.co/600x600?text=Monitor+2",
    ...
    features: [
      "49-inch DQHD resolution",
      "1000R curvature",
      "240Hz refresh rate",
      "1ms response time",
      "NVIDIA G-SYNC and FreeSync Premium Pro",
    ],
  },
  {
    id: 11,
    ...
    images: [
      {
        url: "https://placehold.co/600x600?text=PS5+1",
        alt: "PS5 front view",
      },
      {
        url: "https://placehold.co/600x600?text=PS5+2",
        alt: "PS5 side view",
      },
    ],
    specs: {
  ...
  },
  {
    ...
    images: [
      {
        url: "https://placehold.co/600x600?text=Xbox+1",
        alt: "Xbox front view",
      },
      {
        url: "https://placehold.co/600x600?text=Xbox+2",
        alt: "Xbox side view",
      },
    ],
    specs: {
...
export const TRENDING_PRODUCTS = [
  {
    ...
    images: [
      {
        url: "https://placehold.co/600x600?text=Switch+1",
        alt: "Switch front view",
      },
      {
        url: "https://placehold.co/600x600?text=Switch+2",
        alt: "Switch side view",
      },
    ],
    specs: {
      Capacity: "64GB",
  ...
  },
  {
    id: 14,
    title:
      "Billebon Extra Soft Memory Foam Luxury Travel Neck Support Rest Pillow with Soft Washable & Removable Cover, Multipurpose Comfortable Travel Pillow",
    price: 499,
    mrp: 1699,
    discount: 71,
    rating: 4.5,
    ...
    images: [
      {
        url: "https://m.media-amazon.com/images/I/81xpt7udMsL._SX679_.jpg",
        alt: "Pillow front view",
      },
      {
        url: "https://m.media-amazon.com/images/I/71O0d067QLL._SX679_.jpg",
        alt: "Pillow",
      },
      {
        url: "https://m.media-amazon.com/images/I/81IWQ+LCQsL._SX679_.jpg",
        alt: "Pillow",
      },
    ],
    specs: {
